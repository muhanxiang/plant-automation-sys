...
export default {
  ...
  methods: {
    ...
    getCheckedNodes(leafOnly, includeHalfChecked, filterLeafChecked) {
      return this.store.getCheckedNodes(leafOnly, includeHalfChecked, filterLeafChecked);
    },
