<template>
  <div id="alarm">
    <el-menu class="alarm-menu" mode="horizontal" :default-active="activeMenu" router>
      <template v-for="route in menuList">
        <el-menu-item v-if="!route.meta.hidden" :key="route.path" :index="`/events/alarm/${route.path}`" :route="route">
          {{ route.meta.title }}
        </el-menu-item>
      </template>
    </el-menu>
    <div class="alarm-view sy-view">
...
<script>
import { alarmRoutes } from '@/router';
