  ...
  <el-row id="video_monitor" class="sy-row" :gutter="10">
    <el-col class="sy-col" :span="5">
      <div class="video-tree sy-view">
        <div class="video-tree-statis">
          <div class="video-tree-statis__total">
            <label class="name">设备总数</label>
            <span class="value">{{ videoStatis.total }}</span>
          </div>
          <div class="video-tree-statis__right">
            <div class="video-tree-statis__item online">
              <label class="name">在线</label>
              <span class="value">{{ videoStatis.online }}</span>
            </div>
            <div class="video-tree-statis__item offline">
              <label class="name">离线</label>
              <span class="value">{{ videoStatis.offline }}</span>
            </div>
          </div>
        </div>
        <div class="video-tree-filter">
          <el-input
            class="video-tree-search"
        ...
        <el-checkbox-group class="video-tree-checkbox sy-checkbox-group" v-model="cameraType" @change="onCameraSearch">
          <el-checkbox v-for="item in cameraTypes" :key="item.key" :label="item.key" border>
            {{ item.value }}
          </el-checkbox>
        </el-checkbox-group>
      ...
      <div class="video-player sy-view">
        <div class="video-player-header">
          ...
          <span class="video-player-header__action">
            <el-button class="sy-btn-regular" type="primary" size="small" @click="handleCloseAll">全部关闭</el-button>
          </span>
        </div>
    ...
    <el-col class="sy-col" :span="5">
      <div class="video-control sy-view">
        ...
        <div class="video-control-preset">
          <div class="video-control-preset__title">预置位列表</div>
